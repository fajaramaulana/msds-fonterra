...
@section('sub-judul', 'Tambah Portofolio')
@section('content')
    <form method="POST" id="form-portofolio" enctype="multipart/form-data">
        ...
        <div class="form-group">
            <label>Nama</label>
            <input type="text" class="form-control" id="name" name="name" placeholder="Masukan Nama Pengerjaan">
        </div>
    ...
    <script type="text/javascript">
        $('form').submit(function(event) {
            ...
            $.ajax({
                url: '{{ route('portofoliomanagement.store') }}',
                type: 'POST',
                data: formData,
                processData: false,
                contentType: false,
